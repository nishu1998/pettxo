...
class _PhoneSignupField extends StatefulWidget {
  const _PhoneSignupField({
    this.focusNode,
    this.errorText,
  ...
  @override
  State<_PhoneSignupField> createState() => _PhoneSignupFieldState();
}

class _PhoneSignupFieldState extends State<_PhoneSignupField> {
...
class _PhoneSignupConsentRow extends StatelessWidget {
  const _PhoneSignupConsentRow({
    required this.value,
...
class _PhoneSignupPrimaryButton extends StatelessWidget {
  const _PhoneSignupPrimaryButton({
    required this.label,
...
class _PhoneSignupSecondaryButton extends StatelessWidget {
  const _PhoneSignupSecondaryButton({
    required this.label,
    required this.compact,
    required this.onPressed,
  });
